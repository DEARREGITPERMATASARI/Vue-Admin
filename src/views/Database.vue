              ...
              <div class="table-responsive">
                <b-table striped hover :items="wisata" :fields="fields">
                  ...
                  <template v-slot:cell(foto)="data">
                    <img style="width:200px; height: 150px; border-radius:10%" :src="'http://localhost:8000/backend_WEB/' + data.item.foto" />
                    <!-- {{ url('/backend_WEB/'.data.item.foto) }} -->
 ...
 methods: {
    ...
    Save : function(){
      ...
      if(this.action === "insert"){
        ...
        this.axios.post("http://127.0.0.1:8000/api/tambah_Wisata/", form, conf)
        .then(response => {
          this.$bvToast.hide("loadingToast");
          if(this.search == ""){
            this.getData();
